...
<div class="main_box">
        ...
        <?php xl('Overwrite HIPAA choice','e')?> :<SELECT NAME="hipaa_choice">
                                    <?php
           ...
           <?php xl('Age From','e')?>:<INPUT TYPE="text" size="2" NAME="age_from"> <?php xl('Up to','e')?>:<INPUT TYPE="text" size="2" NAME="age_upto"><br>
 ...
 <td>&nbsp;</td><br>
    ...
    (<?php xl('Fill here only if sending email notification to patients','e')?>)</td><br>
   <td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
   </tr><tr><td>
